...
quant_path = "/data/models/qwen2vl_72b_all_P1P2_28122024_20eps_merged_py_script_4bit_test4"
...
dataset = prepare_dataset(n_sample=10)
...
#model.to(device_map)
model.quantize(dataset, batch_size=2, calibration_enable_gpu_cache=False)
