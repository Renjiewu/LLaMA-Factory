...
PYTHONPATH=/app:/app/data/models OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=5 VLLM_USE_V1=1 NCCL_P2P_DISABLE=1 HF_HUB_OFFLINE=0 VLLM_ATTENTION_BACKEND=FLASHINFER_VLLM_V1 VLLM_USE_FLASHINFER_SAMPLER=1 python /app/run/debug_vllm.py serve \
    "/app/data/models/dots_ocr" \
