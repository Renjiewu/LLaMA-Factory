...
PYTHONPATH=/app CUDA_VISIBLE_DEVICES=6,7 VLLM_USE_V1=1 NCCL_P2P_DISABLE=0 HF_HUB_OFFLINE=0 VLLM_ATTENTION_BACKEND=FLASHINFER_VLLM_V1 VLLM_USE_FLASHINFER_SAMPLER=1 vllm serve \
    "Qwen/Qwen3-30B-A3B-GPTQ-Int4" \
    --max-model-len 32786 \
